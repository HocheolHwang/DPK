...
using WhaleStateItem;
using Photon.Pun;

public class WhaleController : BaseMonsterController
{
    // KnightG가 가지는 상태
    ...
    private WhaleAnimationData _animData;
    public WhaleAnimationData WhaleAnimData { get => _animData; }
    ...
    {
        _animData = GetComponent<WhaleAnimationData>();
        ...
        UnitType = Define.UnitType.Whale;
    }
