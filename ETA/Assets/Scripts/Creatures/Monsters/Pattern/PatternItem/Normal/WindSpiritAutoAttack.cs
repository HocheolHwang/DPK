...
public class WindSpiritAutoAttack : Pattern
{
    [Header("개발 편의성")]
    [SerializeField] float _hitboxForwardLoc = 0.7f;
    [SerializeField] Vector3 _hitboxRange = new Vector3(3f, 3f, 3f);
    ...
    public override IEnumerator StartPatternCast()
    {
        ...
        ParticleSystem ps = Managers.Effect.Play(Define.Effect.WindSpiritAttack, 1.0f, gameObject.transform);
        ps.transform.position = hitbox.transform.position;
        Debug.Log($"{ps.name} 소환됨");
