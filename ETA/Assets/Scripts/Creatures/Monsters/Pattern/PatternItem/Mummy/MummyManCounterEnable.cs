...
public class MummyManCounterEnable : Pattern
{
    MummyManAnimationData _animData;
    MummyManController _mcontroller;
    ...
    public override void Init()
    {
        ...
        _mcontroller = _controller.GetComponent<MummyManController>();
        _duration = _animData.ForeShadowingAnim.length * 2.0f;
