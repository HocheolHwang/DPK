...
public class MummyManJump : Pattern
{
    ...
    public override IEnumerator StartPatternCast()
    {
        ...
        ParticleSystem auraPS = Managers.Effect.Play(Define.Effect.Mummy_JumpAura, duration, transform);
        ...
        ParticleSystem downPS = Managers.Effect.Play(Define.Effect.Mummy_JumpDown, 0, transform);
