...
public class WhaleCounterEnable : Pattern
{
    WhaleAnimationData _animData;
    WhaleController _kcontroller;
    ...
    {
        base.Init();
        _animData = _controller.GetComponent<WhaleAnimationData>();
        _kcontroller = _controller.GetComponent<WhaleController>();
