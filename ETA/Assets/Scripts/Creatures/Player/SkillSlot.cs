...
public class SkillSlot : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        {
            case "Warrior": // 워리어
                loadedSkills = new string[] { "DoubleSlash", "TripleSlash", "DrawSword", "WhirlWind", "Guard", "BackStep", "Massacre", "WindSlash" };
                //for(int i = 0; i < 8; i++)
                //{
                ...
                break;
            case "Archer": // 아처
                loadedSkills = new string[]{ "ScatterArrow", "RapidArrow", "ArrowBomb", "WindBall", "WindShield", "ArrowStab", "ForestSpirit", "LightningShot" };
                break;
            case "Mage": // 메이지
