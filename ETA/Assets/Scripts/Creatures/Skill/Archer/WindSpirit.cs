...
public class WindSpirit : Skill
{
    ...
    public override IEnumerator StartSkillCast()
    {
        ...
        Managers.Coroutine.Run(WindSpiritCoroutine());

        //Vector3 spawnPosition = _skillSystem.TargetPosition;
        
        //if(PhotonNetwork.IsMasterClient) PhotonNetwork.Instantiate("Prefabs/Creatures/Player/WindSpirit", spawnPosition, Quaternion.identity);
    ...
    IEnumerator WindSpiritCoroutine()
    {
