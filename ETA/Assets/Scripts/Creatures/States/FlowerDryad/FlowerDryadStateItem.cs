...
namespace FlowerDryadStateItem
{
    // -------------------------------------- IDLE ------------------------------------------------
    #region IDLE
    public class IdleState : FlowerDryadState
    {
        public IdleState(FlowerDryadController controller) : base(controller)
        {
        }
    ...
    // -------------------------------------- IDLE BATTLE ------------------------------------------------
    #region IDLE_BATTLE
    public class IdleBattleState : FlowerDryadState
    {
        public IdleBattleState(FlowerDryadController controller) : base(controller)
        {
        }
    ...
    // -------------------------------------- CHASE ------------------------------------------------
    #region CHASE
    public class ChaseState : FlowerDryadState
    {
        public ChaseState(FlowerDryadController controller) : base(controller)
        {
        }
    ...
    // -------------------------------------- ATTACK ------------------------------------------------
    #region ATTACK
    public class AttackState : FlowerDryadState
    {
        public AttackState(FlowerDryadController controller) : base(controller)
        {
        }
        ...
        public override void Enter()
        {
            ...
            StartCast((int)EFlowerDryadPattern.FirstAuto);
    ...
    public class CounterEnableState : FlowerDryadState
    {
        public CounterEnableState(FlowerDryadController controller) : base(controller)
        {
        }
        ...
        public override void Enter()
        {
            ...
            StartCast((int)EFlowerDryadPattern.CounterEnable);
        }
    ...
    public class CounterAttackState : FlowerDryadState
    {
        public CounterAttackState(FlowerDryadController controller) : base(controller)
        {
        }
        ...
        public override void Enter()
        {
            ...
            StartCast((int)EFlowerDryadPattern.CounterAttack);
        }
    ...
    // -------------------------------------- GLOBAL_DIE ------------------------------------------------
    #region DIE
    public class DieState : FlowerDryadState
    {
        public DieState(FlowerDryadController controller) : base(controller)
        {
        }
    ...
    // -------------------------------------- GLOBAL_GROGGY ------------------------------------------------
    #region GROGGY
    public class GroggyState : FlowerDryadState
    {
        ParticleSystem ps;
        float groggyTime = 0;
        public GroggyState(FlowerDryadController controller) : base(controller)
        {
        }
    ...
    // -------------------------------------- GLOBAL ------------------------------------------------
    #region GLOBAL
    public class GlobalState : FlowerDryadState
    {
        public GlobalState(FlowerDryadController controller) : base(controller)
        {
        }
