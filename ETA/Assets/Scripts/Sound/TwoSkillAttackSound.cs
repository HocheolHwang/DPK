...
{
    public class TwoSkillAttackSound : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            m_Source.PlayDelayed(ps.main.startDelayMultiplier);
            ...
            if (destroyWhenDone)
            {
                float life = ps.main.startDelayMultiplier + m_Source.clip.length / m_Source.pitch;
